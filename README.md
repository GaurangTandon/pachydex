...
1. Automatically index relevant content on the web with zero user interaction
2. All processing must be 100% on-device.
3. Search should be robust even with 10K+ count of entries in the database.
